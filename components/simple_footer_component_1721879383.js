...
*/
Vue.component("simple_footer_component_1721879383", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            SnapShot - Capture Life's Moments
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Experience photography like never before with our intuitive camera app. Crafted with passion for preserving memories in stunning detail.
                    </div>
                </div>
            </div>
        </footer> 
